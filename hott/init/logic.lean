...
-/
import hott.init.path hott.init.meta.rewrite
...
if Hc :: c then Hc else begin
  have: empty = is_unit c, {delta is_unit, rwr if_neg Hc},
  have: empty, {rwr this, assumption},
  cases this
end
...
if Hc :: c then
  begin
    have: empty = is_empty c, {delta is_empty, rwr if_pos Hc},
    intro c, rwr this, assumption
  end
else Hc
